package com.vsun.controlcenter.customui;

/**
 * Created by ubuntu on 17-11-27.
 */
...
public class RectProgress extends View {
    ...
    private String TAG = "RectProgress";
    private final int VERTICAL = 1;
    private final int HORIZONTAL = 2;

    private final int defaultBgColor = 0x90000000;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            rectRadius = typedArray.getDimensionPixelSize(R.styleable.RectProgress_rectRadius, 34);
            if (max < progress) {
                progress = max;
            }
            typedArray.recycle();
